    ...
    return (
        <DashboardLayout activeMenu="My Files">
            <div className="p-6">
                ...
                {files.length === 0 ? (
                    <div className="bg-white rounded-lg shadow p-12 flex flex-col items-center justify-center dark:bg-zinc-900 dark:shadow-none dark:border dark:border-zinc-800">
                        <File
                            size={60}
                            className="text-purple-300 mb-4"
                        />
                        <h3 className="text-xl font-medium text-gray-700 mb-2 dark:text-zinc-200">
                            No files uploaded yet
                        </h3>
                        <p className="text-gray-500 text-center max-w-md mb-6 dark:text-zinc-400">
                    ...
                    <div className="overflow-x-auto bg-white rounded-lg shadow dark:bg-zinc-900 dark:shadow-none dark:border dark:border-zinc-800">
                        <table className="min-w-full">
                            <thead className="bg-gray-50 border-b border-gray-200 dark:bg-zinc-950/40 dark:border-zinc-800">
                            <tr>
                                <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider dark:text-zinc-400">Name</th>
                                <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider dark:text-zinc-400">Size</th>
                                <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider dark:text-zinc-400">Uploaded</th>
                                <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider dark:text-zinc-400">Sharing</th>
                                <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider dark:text-zinc-400">Actions</th>
                            </tr>
                            </thead>
