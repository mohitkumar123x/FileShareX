    ...
    return (
        <DashboardLayout activeMenu="Dashboard">
            <div className="p-6">
                ...
                <p className="text-gray-600 mb-6 dark:text-zinc-400">Upload, manage, and share your files securely</p>
                {message && (
                ...
                <div className="flex flex-col md:flex-row gap-6">
                    ...
                    <div className="w-full md:w-[60%]">
                        {loading ? (
                            <div className="bg-white rounded-lg shadow p-8 flex flex-col items-center justify-center min-h-[300px] dark:bg-zinc-900 dark:shadow-none dark:border dark:border-zinc-800">
                                <Loader2 size={40} className="text-purple-500 animate-spin mb-4" />
                                <p className="text-gray-500 dark:text-zinc-400">Loading your files...</p>
                            </div>
                        ) : (
