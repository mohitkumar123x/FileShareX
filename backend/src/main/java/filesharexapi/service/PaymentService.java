package filesharexapi.service;

import com.razorpay.Order;
import com.razorpay.RazorpayClient;
import filesharexapi.document.PaymentTransaction;
import filesharexapi.document.ProfileDocument;
import filesharexapi.dto.PaymentDTO;
import filesharexapi.dto.PaymentVerificationDTO;
import filesharexapi.repository.PaymentTransactionRepository;
...
public class PaymentService {
    ...
    public PaymentDTO createOrder(PaymentDTO paymentDTO) {
        try {
            ...
            // Mock mode if no keys are set
            if (razorpayKeyId == null || razorpayKeyId.isEmpty() || razorpayKeyId.equals("ADD_YOUR_RAZORPAY_KEY")) {
                orderId = "mock_order_" + System.currentTimeMillis();
            } else {
            ...
            return PaymentDTO.builder()
                    ...
                    .isMock(razorpayKeyId == null || razorpayKeyId.isEmpty() || razorpayKeyId.equals("ADD_YOUR_RAZORPAY_KEY"))
                    .build();
        ...
        try {
            ...
            if (razorpayKeyId == null || razorpayKeyId.isEmpty() || razorpayKeyId.equals("ADD_YOUR_RAZORPAY_KEY")) {
                ...
                if (creditsToAdd > 0) {
                    ...
                    updateTransactionStatus(request.getRazorpay_order_id(), "SUCCESS", "mock_payment_" + System.currentTimeMillis(), creditsToAdd);
                    return PaymentDTO.builder()
                            .success(true)
                            .message("Payment verified and credits added successfully (Mock Mode)")
                            .credits(userCreditsService.getUserCredits(clerkId).getCredits())
                            .build();
                } else {
                    updateTransactionStatus(request.getRazorpay_order_id(), "FAILED", null, null);
                    return PaymentDTO.builder()
                            .success(false)
